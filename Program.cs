...
Console.WriteLine();
// Ejercicio 1
Console.WriteLine("Ejercicio 1 => Crea una estructura de datos para un cliente con estos campos: Nombre completo, Teléfono, Dirección, Email");
Console.WriteLine();
// Si es nuevo cliente
// Bonus: escribe un método para presentar estos datos desde la estructura al hacer Console.WriteLine(...)

Clientes cliente1 = new Clientes("Maria Pulido", "809-758-6235", "c/guarocuya #52", "mariapulido@algo.com");
Clientes cliente2 = cliente1 with { Nombre_Completo = "Carlos Perez", Email = "carlosperez@otro.com" };
Console.WriteLine(cliente1);
Console.WriteLine();
Console.WriteLine(cliente2);
public struct Clientes {

    public Clientes(string nombre_completo, string telefono, string direccion, string email) {
    ...
    public override string ToString() => ($" El cliente {Nombre_Completo}, cuyo número de contacto es {Telefono}, vive en {Direccion} y tiene el correo {Email}");
